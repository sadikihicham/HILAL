// Palettes dark/light. Copie autonome de l'app mobile (../../src/theme.ts) : le
// desktop ne doit pas importer hors de desktop/ (isolation build CI). Le champ
// `statusBar` est conservé pour la parité de types mais inutilisé en desktop.
